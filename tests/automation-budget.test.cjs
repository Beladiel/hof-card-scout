...
assert.match(worker,/runnerEnabled: true, targetRunnerEnabled: true, collectionRunnerEnabled: false/,'target monitoring may be scheduled while collection rotation remains off');
